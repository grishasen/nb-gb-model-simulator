...
- The gradient boosting section is still educational, but now uses logistic-style gradient/hessian leaf scores, sidebar controls for tree count/depth/learning rate, and a simple calibration layer on top of the final raw score.
